...
export const useSolutionStore = defineStore('solution', () => {
  ...
  async function exportImage(index) {
    ...
    try {
      ...
      footer.innerHTML = `<div style="display:flex;align-items:center;gap:6px;"><span style="font-weight:600;">Interview_Assistant</span></div><div>${new Date().toLocaleDateString('zh-CN', { year: 'numeric', month: 'long', day: 'numeric' })}</div>`
